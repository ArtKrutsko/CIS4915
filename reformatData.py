...
student_data = pd.read_csv("data/ML - Curricular Analytics - PIDM ONLY & Fixed Repeat IND.csv", low_memory=False)
grades = pd.read_csv("data/parsed_grades.csv")
...
#Output to .csv
student_data.to_csv("data/full_set.csv", index=False)
